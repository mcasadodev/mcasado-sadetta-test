...
namespace MCasado.Events
{
    ...
    public class LoadEventChannelSO : ScriptableObject
    {
        ...
        public void RaiseEvent(GameSceneSO[] locationsToLoad, bool showLoadingScreen, bool fade)
        {
            if (OnLoadingRequested != null)
            {
                OnLoadingRequested.Invoke(locationsToLoad, showLoadingScreen, fade);
            }
            else
            {
